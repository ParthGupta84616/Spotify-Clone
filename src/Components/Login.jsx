...
//       <div className="bg-gradient-to-b from-gray-800 to-black flex flex-col items-center justify-center h-screen">
//         <div className="flex flex-col items-center justify-center w-1/2 bg-black rounded-xl -mt-64">
//           <h1 className="text-white text-5xl mt-12 mb-10">Login To Spotify</h1>
//           <button className="flex items-center mt-6 text-gray-200 border border-gray-400 rounded-full px-6 py-3 w-80">
...
//           </button>
//           <button className="mt-6 text-gray-200 border border-gray-400 rounded-full px-6 py-3 w-80"><strong  >Continue With Phone Number</strong></button>
//         </div>
//         <div className="w-1/3 h-px bg-gray-600 mt-7"></div> 
    ...
    <div className='bg-black'>
      ...
      <div className="bg-black rounded-xl w-full sm:w-2/3 md:w-1/2 lg:w-1/2 xl:w-1/2 px-4 py-8 shadow-lg sm:-mt-24 md:-mt-32 lg:-mt-36 xl:-mt-40">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <button className="flex items-center mt-6 text-gray-200 border border-gray-400 rounded-full px-6 py-3 w-full sm:w-auto">
              <img src="https://imgs.search.brave.com/nWZqJGV2j3TkAAV_rtOHoln4Ubcw4TysMJHaJstkLfI/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9sb2dv/ZG93bmxvYWQub3Jn/L3dwLWNvbnRlbnQv/dXBsb2Fkcy8yMDE0/LzA5L2ZhY2Vib29r/LWxvZ28tMC5wbmc" alt="facebook_logo" className=" h-8  ml-4" />
              <strong className='ml-8'>Continue With Facebook</strong>
            </button>
            <button className="flex items-center mt-6 text-gray-200 border border-gray-400 rounded-full px-6 py-3 w-full sm:w-auto">
